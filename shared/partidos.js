...
export function completarPartidos(grupo, fecha2, fecha3) {
    ...
    document.getElementById('equipo3-3').textContent = equiposGrupo[3].equipo;
    document.getElementById('bandera3-3').src = `../recursos/banderas/${equiposGrupo[3].bandera}`;
    ...
    document.getElementById('equipo0-3').textContent = equiposGrupo[0].equipo;
    document.getElementById('bandera0-3').src = `../recursos/banderas/${equiposGrupo[0].bandera}`;

    document.getElementById('equipo2-3').textContent = equiposGrupo[2].equipo;
    document.getElementById('bandera2-3').src = `../recursos/banderas/${equiposGrupo[2].bandera}`;
}